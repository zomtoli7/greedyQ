# greedyQ v0.1 Specification (Archived)

> Historical record only. This draft has been superseded by the [active v0.2 specification](../../greedyq-v0.2-spec.md) and MUST NOT be used for new studies.
