...
학술적으로 greedyQ를 사용할 때는 독립적인 greedyQ runtime만 사용하고 surveydown을 실행하지 않은 경우에도 greedyQ GitHub 저장소와 surveydown PLOS ONE 논문을 함께 인용하도록 요청합니다. 이 학술 인용 정책은 software license 준수와 별개입니다. 자세한 내용은 [CITATION(kor).md](./CITATION(kor).md)를 참고하십시오.
