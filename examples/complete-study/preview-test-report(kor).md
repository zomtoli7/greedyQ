...
- 2026-09-07 기준 계약 테스트 32개가 통과했습니다.
...
모델 테스트는 control과 treatment의 정상 경로, 동의 거부와 선별 탈락, 삭제 요청이 있는 철회와 없는 철회, 모든 종료 결과, 조건부 문항의 표시·비표시 상태, 필수 응답 오류, 숫자 범위, 경로 해석, 진행 경로, ID 중복, 선택지 매핑을 다룹니다.
